...
import frc.robot.Libraries.COTSTalonFXSwerveConstants;
...
//The following lines of code are needed to be tested to determine the setpoints
        public static final double CORAL_MOTOR_SPEED = 0.5;
        public static final double CORAL_GEAR_RATIO = 1.0/3; // fricking floating point
    }
